...
<section class="bg-gray-50 p-3 sm:p-5">
    <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <?php if (session()->has('profile_success')): ?>
            <div class="md:col-span-2 p-3 text-sm text-green-800 rounded-lg bg-green-50" role="alert">
                <?= session('profile_success') ?>
            </div>
        <?php endif; ?>

        <?php if (session()->has('profile_error')): ?>
            <div class="md:col-span-2 p-3 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
